    ...
    <form class="clearfix" role="form" action="{{ route('email') }}" method="post" id="email-form">
        <div class="step-content">
            <div class="center">
                ...
                <p>
                    This is the email where all messages sent by users via the contact form and account confirmations
                    will be sent.
                </p>
                <p class="m-b-lg">
                    This is optional but if you skip this step your users will no longer be able to send emails and also
                    they will no longer receive account confirmations.
                </p>
                <p class="m-b-lg">
                    Atention! If you choose PHP Mail, you will only need to fill Sender Name, Sender Email and Support
                    Email!
                </p>
                ...
                <div class="form-group @if ($errors->has('username')) has-error @endif">
                    ...
                    <input type="text" name="username" id="username" placeholder="eg: some-email@gmail.com"
                           class="form-control">
                ...
                <div class="form-group @if ($errors->has('password')) has-error @endif">
                    ...
                    <input type="password" name="password" id="password" placeholder="eg: email password"
                           class="form-control">
                ...
                <div class="form-group @if ($errors->has('sender-email')) has-error @endif">
                    ...
                    <input type="text" name="sender-email" id="sender-email" placeholder="eg: some-email@gmail.com"
                           class="form-control">
                ...
                <div class="form-group @if ($errors->has('sender-name')) has-error @endif">
                    ...
                    <input type="text" name="sender-name" id="sender-name" placeholder="eg: SmileApp"
                           class="form-control">
                ...
                <div class="form-group @if ($errors->has('support')) has-error @endif">
                    ...
                    <input type="text" name="support" id="support" placeholder="eg: contact@smile.com"
                           class="form-control">
