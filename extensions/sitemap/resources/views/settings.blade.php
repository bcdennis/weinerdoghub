            ...
            <div class="ibox">
                <div class="ibox-content settings settings-social-media">
                    ...
                    <div class="row m-b-lg">
                        <div class="col-md-12">
                            <p>
                                Having a lot of links into your site usually means more work for search engines when
                                they crawl for the pages.
                            </p>
                            <p>
                    ...
                    <div class="row m-b-lg">
                        <div class="col-md-12">
                            ...
                            <form class="m-b-md" role="form" method="post"
                                  action="{{ route('admin.extensions.sitemap.settings') }}">
